...
def forecast_restart_args(
    ...
    *,
    ...
    return argparse.Namespace(
        ...
        forecast_boundary_inflow_file=str(payload.get("forecast_boundary_inflow_file", payload.get("boundary_inflow_file", "")) or "").strip(),
        forecast_boundary_date_field=str(payload.get("forecast_boundary_date_field", payload.get("boundary_date_field", "")) or "").strip(),
        forecast_boundary_flow_field=str(payload.get("forecast_boundary_flow_field", payload.get("boundary_flow_field", "")) or "").strip(),
        forecast_boundary_gap_fill=str(payload.get("forecast_boundary_gap_fill", payload.get("boundary_gap_fill", "")) or "").strip(),
...
def forecast_restart_start_plan(
    ...
    return ForecastRestartStartPlan(
        ...
        metadata={
            ...
            "forecast_boundary_inflow_file": str(getattr(args, "forecast_boundary_inflow_file", "") or ""),
