...
def main():
    ...
    prec_source = str(meteo.get("降水来源", meteo.get("降水源", config.get("默认降水源", "mswep")))).strip().lower()
    ...
    if need_temp_download and args.内容 in {"pet", "era5", "mswep说明"}:
