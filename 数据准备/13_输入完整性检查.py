...
def main():
    parser = argparse.ArgumentParser(description="检查当前流域运行目录的输入是否齐全。")
    ...
    validation = validate_workspace_fields(config_path, stage="calibration", precip_source=args.降水源)
    details = workspace_detailed_check(config_path, precip_source=args.降水源)
